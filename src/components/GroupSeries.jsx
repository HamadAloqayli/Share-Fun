...
const GroupSeries = (props) => {
    ...
    const deleteMovie = (movie) => {
        ...
        firestore.collection('Groups').doc(groupID).collection('series').doc(movie.id).delete()
        .then(res => tempShowMessage(`${movie.data().title} series was deleted successfully`,'suc'))
